...
enum class Platform(val platformName: String, private val fallback: List<Platform> = listOf()) {
    ...
    FEDORA_31("Fedora_31", fallback = listOf(FEDORA_30, FEDORA, CENTOS)),
    FEDORA_32("Fedora_31", fallback = listOf(FEDORA_31, FEDORA_30, FEDORA, CENTOS)),
    FEDORA_33("Fedora_31", fallback = listOf(FEDORA_32, FEDORA_31, FEDORA_30, FEDORA, CENTOS)),
    ...
    FEDORA_SERVER_31("Fedora_Server_31", fallback = listOf(FEDORA_SERVER_30, FEDORA_30, FEDORA_SERVER, FEDORA, CENTOS)),
    FEDORA_SERVER_32("Fedora_Server_32", fallback = listOf(FEDORA_SERVER_31, FEDORA_SERVER_30, FEDORA_30, FEDORA_SERVER, FEDORA, CENTOS)),
    FEDORA_SERVER_33("Fedora_Server_33", fallback = listOf(FEDORA_SERVER_32, FEDORA_SERVER_31, FEDORA_SERVER_30, FEDORA_30, FEDORA_SERVER, FEDORA, CENTOS)),
    REDHAT("RedHat"),
    LINUX("Linux"),
    MAC_OS("macOS"),
    WINDOWS("Windows"),
